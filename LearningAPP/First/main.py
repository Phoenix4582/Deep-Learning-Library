...
def prep_train(ds_train, AUTOTUNE, BATCH_SIZE):
...
def prep_test(ds_test, AUTOTUNE, BATCH_SIZE):
...
# Data preparation
ds_train = prep_train(ds_train, AUTOTUNE, BATCH_SIZE)
ds_test = prep_test(ds_train, AUTOTUNE, BATCH_SIZE)
